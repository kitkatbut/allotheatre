...
include_once $this->targetDirs[2].'/vendor/symfony/framework-bundle/CacheWarmer/AbstractPhpFileCacheWarmer.php';
include_once $this->targetDirs[2].'/vendor/symfony/framework-bundle/CacheWarmer/AnnotationsCacheWarmer.php';
