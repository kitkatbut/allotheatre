...
include_once $this->targetDirs[2].'/vendor/symfony/validator/ConstraintValidatorFactoryInterface.php';
include_once $this->targetDirs[2].'/vendor/symfony/validator/ContainerConstraintValidatorFactory.php';
include_once $this->targetDirs[2].'/vendor/symfony/validator/ObjectInitializerInterface.php';
include_once $this->targetDirs[2].'/vendor/symfony/doctrine-bridge/Validator/DoctrineInitializer.php';
include_once $this->targetDirs[2].'/vendor/symfony/validator/Validation.php';
...
$instance->addXmlMappings(array(0 => ($this->targetDirs[2].'/vendor/symfony/form/Resources/config/validation.xml')));
