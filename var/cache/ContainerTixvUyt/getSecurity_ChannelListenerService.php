...
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/EntryPoint/AuthenticationEntryPointInterface.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/EntryPoint/RetryAuthenticationEntryPoint.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Firewall/ListenerInterface.php';
include_once $this->targetDirs[2].'/vendor/symfony/security/Http/Firewall/ChannelListener.php';
