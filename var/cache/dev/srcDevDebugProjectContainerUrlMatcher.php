...
class srcDevDebugProjectContainerUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($rawPathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/login')) {
            ...
            // login
            if ('/login' === $pathinfo) {
                return array (  '_controller' => 'App\\Controller\\SitePublicController::loginAction',  '_route' => 'login',);
            }
        ...
        // admin
        if ('/admin' === $pathinfo) {
            return array (  '_controller' => 'App\\Controller\\SecurityController::adminAction',  '_route' => 'admin',);
        }
